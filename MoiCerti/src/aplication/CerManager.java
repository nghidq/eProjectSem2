...
public class CerManager {
    ...
    public ResultSet showCerManager() throws SQLException {
       //cn.getConnect();
        String sql = "SELECT C.NO_ID, A.STUDENT_ID, B.STUDENT_NAME, C.ID_NUM, D.CERTIFICATE_NAME " 
                ...
                + "GROUP BY C.NO_ID, A.STUDENT_ID, B.STUDENT_NAME, C.ID_NUM, D.CERTIFICATE_NAME";
