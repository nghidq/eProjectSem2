...
public class Students {
    ...
    public ResultSet showStudent() throws SQLException {
       DBconnect.getConnect();
        String sql = "SELECT STUDENT_ID, STUDENT_NAME, IDENTITY_CARD, DOB, "
                + "GENDER, PHONE, EMAIL, STUDENT_ADD FROM STUDENTS";
...
//Theo moi 1 dong du lieu vao table
    ...
    public void insertData(String id, String fullname, String idCard, String dob, String male,
             String phone, String mail, String add) throws SQLException {
        DBconnect.getConnect();
        String sql = "INSERT INTO STUDENTS "
                + "VALUES('" + id + "',N'" + fullname + "',N'" + idCard + "',N'" 
                + dob + "',N'" + male + "',N'" + phone + "',N'" + mail + "',N'" + add + "')";
        DBconnect.updateData(sql);
    }
//Dieu chinh 1 dong du lieu vao table

    public void editData(String id, String fullname, String idCard, String dob, String male,
            String phone, String mail, String add) throws SQLException {
        DBconnect.getConnect();
