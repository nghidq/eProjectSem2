...
//Xoa trang cac JtextField
        //this.txtIDuser.setText(null);
        //this.cbtRegStuID.setSelectedItem(null);
        this.txtRegFullName.setText(null);
        long millis = System.currentTimeMillis();
        java.sql.Date dateExam = new java.sql.Date(millis);
        this.txtRegDateExam.setDate(dateExam);
...
//Khoa hoac mo khoa cho Cac JTextField
        ...
        this.txtRegDateExam.setEnabled(!a);
    }
//Ham khoa cac Button
...
//gọi hàm ShowData để đưa dữ liệu vào tableModel
    ...
    private void initComponents() {
        ...
        txtRegDateExam = new com.toedter.calendar.JDateChooser();
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbtRegStuID, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cbtRegCert, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(txtRegDateExam, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(txtRegIDNum))
                .addContainerGap())
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(45, 45, 45)
                        .addComponent(btnRegStuClose, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(46, 46, 46))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel4)
                    .addComponent(txtRegDateExam, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnStuRegSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnStuRegSaveMouseClicked
        ...
        if (fullname.matches("^[a-zA-Z_0-9\\s]{5,40}") == false) {
            ...
            try {
                ...
                if (flag == true) {
                    stuRegObj.insertData(stuId, fullname, idCard, sex, dob, phone, mail, add);
                    jLabelNotify.setVisible(true);
                } else {
                    stuRegObj.editData(stuId, fullname, idCard, sex, dob, phone, mail, add);
                    jLabelNotify.setVisible(true);
                }
    ...
    private void jTableRegistryMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableRegistryMouseClicked
        ...
        try {
            ...
            if (rs2.next()) {
                ...
                long millis = System.currentTimeMillis();
                java.sql.Date date = new java.sql.Date(millis);
                txtRegDateExam.setDate(rs2.getDate("EXAM_DATE"));
    ...
    private void btnRegisterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegisterMouseClicked
        ...
        setClockReg(false);//Mo khoa TextField
    ...
    private void btnRegisterSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegisterSaveMouseClicked
        // TODO add your handling code here:
        Date dateExam = txtRegDateExam.getDate();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        ...
        if (idStu.length() == 0) {
            ...
            txtStuRegIDCard.requestFocus();
        } else if (getDateExam(calendar) <= 1 && getDayExam(calendar) < 20) {
            JOptionPane.showMessageDialog(null, "must be over 20 days new to register!", "Message", 1);
            txtRegDateExam.requestFocus();
        } else {
            try {

                if (flag == true) {
                    regObj.insertDataReg(idStu, idCer, dExam, idNum);
                    jLabelNotify.setVisible(true);
                } else {
                    regObj.editDataReg(idStu, idCer, dExam, idNum);
                    jLabelNotify.setVisible(true);
                }
    ...
    private com.toedter.calendar.JDateChooser txtRegDateExam;
